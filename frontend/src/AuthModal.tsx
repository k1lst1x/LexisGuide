      ...
      >
        ...
        {(mode === 'signIn' || mode === 'signUp') && (
          <div className="social-auth-buttons">
            <button type="button" className="social-auth-btn google-btn" onClick={handleGoogle} disabled={loading}>
            ...
            <button type="button" className="social-auth-btn apple-btn" onClick={handleApple} disabled={loading}>
